  ...
  return (
    <section id="hot_games" className='flex flex-col pt-8 gap-2 lg:hidden'>
      ...
      <div className='grid grid-cols-2 grid-rows-2 place-items-stretch gap-4 newCards'>
        <a href="https://royalcircleclub.com/?referral=maJhannYt"><img src={LiveCasino1}></img></a>
        <a href="https://royalcircleclub.com/?referral=maJhannYt"><img src={LiveCasino2}></img></a>
        <a href="https://royalcircleclub.com/?referral=maJhannYt"><img src={LiveCasino3}></img></a>
        <a href="https://royalcircleclub.com/?referral=maJhannYt"><img src={LiveCasino4}></img></a>
      </div>
