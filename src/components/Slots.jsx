    ...
    return (
        <section id="hot_games" className='flex flex-col pt-8 gap-2 lg:hidden'>
          ...
          <div className='grid grid-cols-2 grid-rows-2 place-items-stretch gap-4 newCards'>
            <a href="https://playfinooc.vip/r/Maxxwin/reg"><img src={Slots1}></img></a>
            <a href="https://playfinooc.vip/r/Maxxwin/reg"><img src={Slots2}></img></a>
            <a href="https://playfinooc.vip/r/Maxxwin/reg"><img src={Slots3}></img></a>
            <a href="https://playfinooc.vip/r/Maxxwin/reg"><img src={Slots4}></img></a>
          </div>
