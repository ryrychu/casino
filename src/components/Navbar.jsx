...
const Navbar = () => {
  return (
    <nav className='w-full flex py-4 px-20 justify-between items-center'>
      ...
      <div className='inline-flex bg-gradient-to-bl from-secondary to-tertiary rounded-md font-subFont hover:from-[#F6D083] hover:to-[#FFAF05]'>
        <a href="" className='w-[97px] py-2 px-7 items-center'>
